        ...
        <div className=' mt-5 bg-white'>
          ...
          <div>
            <div className='pl-3 py-3 flex justify-start align-center flex-wrap gap-3 sm:gap-4'>
              <NavLink to='opisaniye' style={navLinkStyle} className='hover:text-black no-underline text-[17px] sm:text-xl text-gray-400' >Описание</NavLink>
              <NavLink to='xarakteristika' style={navLinkStyle} className='hover:text-black no-underline text-[17px] sm:text-xl text-gray-400' >Характеристики</NavLink>
              <NavLink to='dostavka' style={navLinkStyle} className='hover:text-black no-underline text-[17px] sm:text-xl text-gray-400' >Доставка</NavLink>
              <NavLink to='otziv' style={navLinkStyle} className='hover:text-black no-underline text-[17px] sm:text-xl text-gray-400' >Отзывы</NavLink>
            </div>
